...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 86 78 10 80 	movl   $0x80107886,(%esp)
...
80100c5d:	e8 1e 65 00 00       	call   80107180 <copyout>
...
80100d0a:	e8 11 3c 00 00       	call   80104920 <safestrcpy>
  curproc->pgdir = pgdir;
...
80101c89:	e8 a2 29 00 00       	call   80104630 <acquire>
  ip->ref++;
80101c8e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c92:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c99:	e8 52 2a 00 00       	call   801046f0 <release>
...
80101cf5:	e8 f6 2a 00 00       	call   801047f0 <memmove>
    path++;
...
80101d88:	e8 63 2a 00 00       	call   801047f0 <memmove>
    name[len] = 0;
...
80101e7d:	e8 3e 2a 00 00       	call   801048c0 <strncpy>
  de.inum = inum;
...
80101ec8:	68 86 7a 10 80       	push   $0x80107a86
...
80102010:	e8 db 24 00 00       	call   801044f0 <initlock>
...
8010208e:	e8 9d 25 00 00       	call   80104630 <acquire>
...
801020f1:	e8 4a 20 00 00       	call   80104140 <wakeup>
...
8010210f:	e8 dc 25 00 00       	call   801046f0 <release>
...
8010212e:	e8 6d 23 00 00       	call   801044a0 <holdingsleep>
...
80102168:	e8 c3 24 00 00       	call   80104630 <acquire>
...
80102342:	e8 f9 23 00 00       	call   80104740 <memset>
...
8010237a:	c9                   	leave  
    release(&kmem.lock);
8010237b:	e9 70 23 00 00       	jmp    801046f0 <release>
    acquire(&kmem.lock);
80102380:	83 ec 0c             	sub    $0xc,%esp
80102383:	68 40 26 11 80       	push   $0x80112640
80102388:	e8 a3 22 00 00       	call   80104630 <acquire>
...
80102405:	e8 e6 20 00 00       	call   801044f0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024f3:	e8 38 21 00 00       	call   80104630 <acquire>
  r = kmem.freelist;
...
80102521:	e8 ca 21 00 00       	call   801046f0 <release>
  return (char*)r;
...
80102937:	e8 54 1e 00 00       	call   80104790 <memcmp>
...
80102a64:	e8 87 1d 00 00       	call   801047f0 <memmove>
...
80102b14:	e8 d7 19 00 00       	call   801044f0 <initlock>
  readsb(dev, &sb);
80102b19:	58                   	pop    %eax
...
80102bab:	e8 80 1a 00 00       	call   80104630 <acquire>
...
80102bfc:	e8 ef 1a 00 00       	call   801046f0 <release>
      break;
    }
  }
}
...
80102c1e:	e8 0d 1a 00 00       	call   80104630 <acquire>
  log.outstanding -= 1;
...
80102c5c:	e8 8f 1a 00 00       	call   801046f0 <release>
}
...
80102cb6:	e8 35 1b 00 00       	call   801047f0 <memmove>
...
80102cff:	e8 2c 19 00 00       	call   80104630 <acquire>
    wakeup(&log);
...
80102d12:	00 00 00 
    wakeup(&log);
80102d15:	e8 26 14 00 00       	call   80104140 <wakeup>
    release(&log.lock);
80102d1a:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d21:	e8 ca 19 00 00       	call   801046f0 <release>
...
80102d40:	e8 fb 13 00 00       	call   80104140 <wakeup>
  release(&log.lock);
80102d45:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d4c:	e8 9f 19 00 00       	call   801046f0 <release>
...
80102dae:	e8 7d 18 00 00       	call   80104630 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dfc:	c9                   	leave  
  release(&log.lock);
80102dfd:	e9 ee 18 00 00       	jmp    801046f0 <release>
...
80102e7a:	e8 81 0c 00 00       	call   80103b00 <scheduler>
80102e7f:	90                   	nop
...
80102ec1:	e8 3a 41 00 00       	call   80107000 <kvmalloc>
...
80102f14:	e8 d7 18 00 00       	call   801047f0 <memmove>
...
80102ff4:	e8 97 17 00 00       	call   80104790 <memcmp>
...
801030b2:	e8 d9 16 00 00       	call   80104790 <memcmp>
...
80103301:	e8 ea 11 00 00       	call   801044f0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010335f:	e8 cc 12 00 00       	call   80104630 <acquire>
  if(writable){
...
8010337f:	e8 bc 0d 00 00       	call   80104140 <wakeup>
...
801033a3:	5d                   	pop    %ebp
    release(&p->lock);
801033a4:	e9 47 13 00 00       	jmp    801046f0 <release>
...
801033c4:	e8 77 0d 00 00       	call   80104140 <wakeup>
...
801033d4:	e8 17 13 00 00       	call   801046f0 <release>
    kfree((char*)p);
...
801033fd:	e8 2e 12 00 00       	call   80104630 <acquire>
  for(i = 0; i < n; i++){
...
80103454:	e8 e7 0c 00 00       	call   80104140 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103459:	5a                   	pop    %edx
8010345a:	59                   	pop    %ecx
...
80103494:	e8 57 12 00 00       	call   801046f0 <release>
        return -1;
...
801034e3:	e8 58 0c 00 00       	call   80104140 <wakeup>
  release(&p->lock);
801034e8:	89 1c 24             	mov    %ebx,(%esp)
801034eb:	e8 00 12 00 00       	call   801046f0 <release>
  return n;
...
80103510:	e8 1b 11 00 00       	call   80104630 <acquire>
...
8010357e:	e8 6d 11 00 00       	call   801046f0 <release>
      return -1;
...
801035d7:	e8 64 0b 00 00       	call   80104140 <wakeup>
  release(&p->lock);
801035dc:	89 34 24             	mov    %esi,(%esp)
801035df:	e8 0c 11 00 00       	call   801046f0 <release>
  return i;
...
80103611:	e8 1a 10 00 00       	call   80104630 <acquire>
...
80103653:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103659:	e8 92 10 00 00       	call   801046f0 <release>
...
8010366b:	74 7c                	je     801036e9 <allocproc+0xe9>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
8010366d:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
80103673:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
80103676:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
8010367b:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010367e:	c7 40 14 97 59 10 80 	movl   $0x80105997,0x14(%eax)
  p->context = (struct context*)sp;
80103685:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103688:	6a 14                	push   $0x14
8010368a:	6a 00                	push   $0x0
8010368c:	50                   	push   %eax
8010368d:	e8 ae 10 00 00       	call   80104740 <memset>
  p->context->eip = (uint)forkret;
80103692:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80103695:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103698:	c7 40 10 00 37 10 80 	movl   $0x80103700,0x10(%eax)
  p->ctime = ticks;
8010369f:	a1 a0 58 11 80       	mov    0x801158a0,%eax
  p->rtime = 0;
801036a4:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
801036ab:	00 00 00 
  p->etime = -1;
801036ae:	c7 83 84 00 00 00 ff 	movl   $0xffffffff,0x84(%ebx)
801036b5:	ff ff ff 
  p->wait_time = ticks - p->ctime;
801036b8:	c7 83 88 00 00 00 00 	movl   $0x0,0x88(%ebx)
801036bf:	00 00 00 
  p->ctime = ticks;
801036c2:	89 43 7c             	mov    %eax,0x7c(%ebx)
}
...
801036da:	e8 11 10 00 00       	call   801046f0 <release>
}
...
8010370b:	e8 e0 0f 00 00       	call   801046f0 <release>
...
80103760:	e8 8b 0d 00 00       	call   801044f0 <initlock>
}
...
801037dd:	68 b4 78 10 80       	push   $0x801078b4
...
80103814:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103817:	e8 44 0d 00 00       	call   80104560 <pushcli>
  c = mycpu();
8010381c:	e8 4f ff ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103821:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103827:	e8 74 0d 00 00       	call   801045a0 <popcli>
}
...
8010384c:	83 ec 0c             	sub    $0xc,%esp
  p = allocproc();
8010384f:	89 c3                	mov    %eax,%ebx
  cprintf("the  process has been called. we are starting work\n");
80103851:	68 dc 78 10 80       	push   $0x801078dc
80103856:	e8 05 ce ff ff       	call   80100660 <cprintf>
  cprintf(" c time of the process was %d and the current time is %d\n",p->  ctime , current_time);
8010385b:	83 c4 0c             	add    $0xc,%esp
8010385e:	ff 35 a0 58 11 80    	pushl  0x801158a0
80103864:	ff 73 7c             	pushl  0x7c(%ebx)
80103867:	68 10 79 10 80       	push   $0x80107910
8010386c:	e8 ef cd ff ff       	call   80100660 <cprintf>
  initproc = p;
80103871:	89 1d b8 a5 10 80    	mov    %ebx,0x8010a5b8
  if((p->pgdir = setupkvm()) == 0)
80103877:	e8 04 37 00 00       	call   80106f80 <setupkvm>
8010387c:	83 c4 10             	add    $0x10,%esp
8010387f:	85 c0                	test   %eax,%eax
80103881:	89 43 04             	mov    %eax,0x4(%ebx)
80103884:	0f 84 bd 00 00 00    	je     80103947 <userinit+0x107>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
8010388a:	83 ec 04             	sub    $0x4,%esp
8010388d:	68 2c 00 00 00       	push   $0x2c
80103892:	68 60 a4 10 80       	push   $0x8010a460
80103897:	50                   	push   %eax
80103898:	e8 c3 33 00 00       	call   80106c60 <inituvm>
  memset(p->tf, 0, sizeof(*p->tf));
8010389d:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
801038a0:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
801038a6:	6a 4c                	push   $0x4c
801038a8:	6a 00                	push   $0x0
801038aa:	ff 73 18             	pushl  0x18(%ebx)
801038ad:	e8 8e 0e 00 00       	call   80104740 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
801038b2:	8b 43 18             	mov    0x18(%ebx),%eax
...
801038c9:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
801038cd:	8b 43 18             	mov    0x18(%ebx),%eax
801038d0:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
801038d4:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
801038d8:	8b 43 18             	mov    0x18(%ebx),%eax
801038db:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
801038df:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
801038e3:	8b 43 18             	mov    0x18(%ebx),%eax
801038e6:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
801038ed:	8b 43 18             	mov    0x18(%ebx),%eax
801038f0:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
801038f7:	8b 43 18             	mov    0x18(%ebx),%eax
801038fa:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103901:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103904:	6a 10                	push   $0x10
80103906:	68 a5 77 10 80       	push   $0x801077a5
8010390b:	50                   	push   %eax
8010390c:	e8 0f 10 00 00       	call   80104920 <safestrcpy>
  p->cwd = namei("/");
80103911:	c7 04 24 ae 77 10 80 	movl   $0x801077ae,(%esp)
80103918:	e8 c3 e5 ff ff       	call   80101ee0 <namei>
8010391d:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103920:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103927:	e8 04 0d 00 00       	call   80104630 <acquire>
  p->state = RUNNABLE;
8010392c:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103933:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010393a:	e8 b1 0d 00 00       	call   801046f0 <release>
}
...
8010394a:	68 8c 77 10 80       	push   $0x8010778c
8010394f:	e8 3c ca ff ff       	call   80100390 <panic>
...
80103965:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103968:	e8 f3 0b 00 00       	call   80104560 <pushcli>
  c = mycpu();
8010396d:	e8 fe fd ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103972:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103978:	e8 23 0c 00 00       	call   801045a0 <popcli>
  if(n > 0){
...
8010398c:	e8 af 31 00 00       	call   80106b40 <switchuvm>
  return 0;
...
801039aa:	e8 f1 33 00 00       	call   80106da0 <allocuvm>
...
801039ca:	e8 01 35 00 00       	call   80106ed0 <deallocuvm>
...
801039e6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039e9:	e8 72 0b 00 00       	call   80104560 <pushcli>
  c = mycpu();
801039ee:	e8 7d fd ff ff       	call   80103770 <mycpu>
  p = c->proc;
801039f3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039f9:	e8 a2 0b 00 00       	call   801045a0 <popcli>
  if((np = allocproc()) == 0){
801039fe:	e8 fd fb ff ff       	call   80103600 <allocproc>
...
80103a18:	e8 33 36 00 00       	call   80107050 <copyuvm>
...
80103a79:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103a7c:	e8 cf db ff ff       	call   80101650 <idup>
...
80103ad5:	e8 36 e8 ff ff       	call   80102310 <kfree>
    np->kstack = 0;
...
80103b06:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
80103b09:	e8 62 fc ff ff       	call   80103770 <mycpu>
  c->proc = 0;
80103b0e:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103b15:	00 00 00 
  struct cpu *c = mycpu();
80103b18:	89 c3                	mov    %eax,%ebx
80103b1a:	8d 40 04             	lea    0x4(%eax),%eax
...
80103b21:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b24:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
    acquire(&ptable.lock);
80103b29:	68 20 2d 11 80       	push   $0x80112d20
80103b2e:	e8 fd 0a 00 00       	call   80104630 <acquire>
80103b33:	83 c4 10             	add    $0x10,%esp
80103b36:	8d 76 00             	lea    0x0(%esi),%esi
80103b39:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      if(p->state != RUNNABLE)
80103b40:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103b44:	75 49                	jne    80103b8f <scheduler+0x8f>
      switchuvm(p);
80103b46:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103b49:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103b4f:	57                   	push   %edi
80103b50:	e8 eb 2f 00 00       	call   80106b40 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103b55:	58                   	pop    %eax
80103b56:	5a                   	pop    %edx
80103b57:	ff 77 1c             	pushl  0x1c(%edi)
80103b5a:	ff 75 e4             	pushl  -0x1c(%ebp)
      int start_run_time = ticks;
80103b5d:	8b 35 a0 58 11 80    	mov    0x801158a0,%esi
      p->state = RUNNING;
80103b63:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103b6a:	e8 0c 0e 00 00       	call   8010497b <swtch>
      p->rtime = end_run_time - start_run_time ;
80103b6f:	8b 15 a0 58 11 80    	mov    0x801158a0,%edx
80103b75:	29 f2                	sub    %esi,%edx
80103b77:	89 97 80 00 00 00    	mov    %edx,0x80(%edi)
      switchkvm();
80103b7d:	e8 9e 2f 00 00       	call   80106b20 <switchkvm>
      c->proc = 0;
80103b82:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103b89:	00 00 00 
80103b8c:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b8f:	81 c7 8c 00 00 00    	add    $0x8c,%edi
80103b95:	81 ff 54 50 11 80    	cmp    $0x80115054,%edi
80103b9b:	72 a3                	jb     80103b40 <scheduler+0x40>
    release(&ptable.lock);
80103b9d:	83 ec 0c             	sub    $0xc,%esp
80103ba0:	68 20 2d 11 80       	push   $0x80112d20
80103ba5:	e8 46 0b 00 00       	call   801046f0 <release>
    sti();
80103baa:	83 c4 10             	add    $0x10,%esp
80103bad:	e9 6e ff ff ff       	jmp    80103b20 <scheduler+0x20>
...
80103bc4:	53                   	push   %ebx
  pushcli();
80103bc5:	e8 96 09 00 00       	call   80104560 <pushcli>
  c = mycpu();
80103bca:	e8 a1 fb ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103bcf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bd5:	e8 c6 09 00 00       	call   801045a0 <popcli>
  if(!holding(&ptable.lock))
80103bda:	83 ec 0c             	sub    $0xc,%esp
80103bdd:	68 20 2d 11 80       	push   $0x80112d20
80103be2:	e8 19 0a 00 00       	call   80104600 <holding>
80103be7:	83 c4 10             	add    $0x10,%esp
80103bea:	85 c0                	test   %eax,%eax
80103bec:	74 4f                	je     80103c3d <sched+0x7d>
  if(mycpu()->ncli != 1)
80103bee:	e8 7d fb ff ff       	call   80103770 <mycpu>
...
80103c07:	75 41                	jne    80103c4a <sched+0x8a>
  intena = mycpu()->intena;
80103c09:	e8 62 fb ff ff       	call   80103770 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103c0e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103c11:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103c17:	e8 54 fb ff ff       	call   80103770 <mycpu>
80103c1c:	83 ec 08             	sub    $0x8,%esp
80103c1f:	ff 70 04             	pushl  0x4(%eax)
80103c22:	53                   	push   %ebx
80103c23:	e8 53 0d 00 00       	call   8010497b <swtch>
  mycpu()->intena = intena;
80103c28:	e8 43 fb ff ff       	call   80103770 <mycpu>
}
...
80103c86:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c89:	e8 d2 08 00 00       	call   80104560 <pushcli>
  c = mycpu();
80103c8e:	e8 dd fa ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103c93:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c99:	e8 02 09 00 00       	call   801045a0 <popcli>
  if(curproc == initproc)
80103c9e:	39 1d b8 a5 10 80    	cmp    %ebx,0x8010a5b8
80103ca4:	8d 73 28             	lea    0x28(%ebx),%esi
80103ca7:	8d 7b 68             	lea    0x68(%ebx),%edi
80103caa:	0f 84 26 01 00 00    	je     80103dd6 <exit+0x156>
    if(curproc->ofile[fd]){
80103cb0:	8b 06                	mov    (%esi),%eax
80103cb2:	85 c0                	test   %eax,%eax
80103cb4:	74 12                	je     80103cc8 <exit+0x48>
      fileclose(curproc->ofile[fd]);
80103cb6:	83 ec 0c             	sub    $0xc,%esp
80103cb9:	50                   	push   %eax
80103cba:	e8 81 d1 ff ff       	call   80100e40 <fileclose>
      curproc->ofile[fd] = 0;
80103cbf:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80103cc5:	83 c4 10             	add    $0x10,%esp
80103cc8:	83 c6 04             	add    $0x4,%esi
  for(fd = 0; fd < NOFILE; fd++){
80103ccb:	39 f7                	cmp    %esi,%edi
80103ccd:	75 e1                	jne    80103cb0 <exit+0x30>
  begin_op();
80103ccf:	e8 cc ee ff ff       	call   80102ba0 <begin_op>
  iput(curproc->cwd);
80103cd4:	83 ec 0c             	sub    $0xc,%esp
80103cd7:	ff 73 68             	pushl  0x68(%ebx)
80103cda:	e8 d1 da ff ff       	call   801017b0 <iput>
  end_op();
80103cdf:	e8 2c ef ff ff       	call   80102c10 <end_op>
  curproc->cwd = 0;
80103ce4:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103ceb:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103cf2:	e8 39 09 00 00       	call   80104630 <acquire>
  wakeup1(curproc->parent);
80103cf7:	8b 53 14             	mov    0x14(%ebx),%edx
...
80103d02:	eb 10                	jmp    80103d14 <exit+0x94>
80103d04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d08:	05 8c 00 00 00       	add    $0x8c,%eax
80103d0d:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80103d12:	73 1e                	jae    80103d32 <exit+0xb2>
    if(p->state == SLEEPING && p->chan == chan)
80103d14:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103d18:	75 ee                	jne    80103d08 <exit+0x88>
80103d1a:	3b 50 20             	cmp    0x20(%eax),%edx
80103d1d:	75 e9                	jne    80103d08 <exit+0x88>
      p->state = RUNNABLE;
80103d1f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d26:	05 8c 00 00 00       	add    $0x8c,%eax
80103d2b:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80103d30:	72 e2                	jb     80103d14 <exit+0x94>
      p->parent = initproc;
80103d32:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d38:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103d3d:	eb 0f                	jmp    80103d4e <exit+0xce>
80103d3f:	90                   	nop
80103d40:	81 c2 8c 00 00 00    	add    $0x8c,%edx
80103d46:	81 fa 54 50 11 80    	cmp    $0x80115054,%edx
80103d4c:	73 3a                	jae    80103d88 <exit+0x108>
    if(p->parent == curproc){
80103d4e:	39 5a 14             	cmp    %ebx,0x14(%edx)
80103d51:	75 ed                	jne    80103d40 <exit+0xc0>
      if(p->state == ZOMBIE)
80103d53:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80103d57:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103d5a:	75 e4                	jne    80103d40 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d5c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103d61:	eb 11                	jmp    80103d74 <exit+0xf4>
80103d63:	90                   	nop
80103d64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d68:	05 8c 00 00 00       	add    $0x8c,%eax
80103d6d:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80103d72:	73 cc                	jae    80103d40 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
80103d74:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103d78:	75 ee                	jne    80103d68 <exit+0xe8>
80103d7a:	3b 48 20             	cmp    0x20(%eax),%ecx
80103d7d:	75 e9                	jne    80103d68 <exit+0xe8>
      p->state = RUNNABLE;
80103d7f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103d86:	eb e0                	jmp    80103d68 <exit+0xe8>
  curproc->etime = ticks;
80103d88:	8b 15 a0 58 11 80    	mov    0x801158a0,%edx
  curproc->wait_time = curproc->etime - curproc->ctime - curproc->rtime;
80103d8e:	8b 4b 7c             	mov    0x7c(%ebx),%ecx
...
80103d91:	83 ec 0c             	sub    $0xc,%esp
  curproc->wait_time = curproc->etime - curproc->ctime - curproc->rtime;
80103d94:	8b b3 80 00 00 00    	mov    0x80(%ebx),%esi
80103d9a:	89 d0                	mov    %edx,%eax
  curproc->etime = ticks;
80103d9c:	89 93 84 00 00 00    	mov    %edx,0x84(%ebx)
  curproc->wait_time = curproc->etime - curproc->ctime - curproc->rtime;
80103da2:	29 c8                	sub    %ecx,%eax
80103da4:	29 f0                	sub    %esi,%eax
80103da6:	89 83 88 00 00 00    	mov    %eax,0x88(%ebx)
  cprintf("creation time : %d run_time = %d end_time = %d wait time = %d\n", curproc->ctime , curproc->rtime , curproc->etime , curproc->wait_time);
80103dac:	50                   	push   %eax
80103dad:	52                   	push   %edx
80103dae:	56                   	push   %esi
80103daf:	51                   	push   %ecx
80103db0:	68 4c 79 10 80       	push   $0x8010794c
80103db5:	e8 a6 c8 ff ff       	call   80100660 <cprintf>
  sched();
80103dba:	83 c4 20             	add    $0x20,%esp
  curproc->state = ZOMBIE;
80103dbd:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103dc4:	e8 f7 fd ff ff       	call   80103bc0 <sched>
  panic("zombie exit");
80103dc9:	83 ec 0c             	sub    $0xc,%esp
80103dcc:	68 fd 77 10 80       	push   $0x801077fd
80103dd1:	e8 ba c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103dd6:	83 ec 0c             	sub    $0xc,%esp
80103dd9:	68 f0 77 10 80       	push   $0x801077f0
...
80103dfc:	e8 2f 08 00 00       	call   80104630 <acquire>
  pushcli();
80103e01:	e8 5a 07 00 00       	call   80104560 <pushcli>
  c = mycpu();
80103e06:	e8 65 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103e0b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e11:	e8 8a 07 00 00       	call   801045a0 <popcli>
  myproc()->state = RUNNABLE;
80103e16:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103e1d:	e8 9e fd ff ff       	call   80103bc0 <sched>
  release(&ptable.lock);
80103e22:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e29:	e8 c2 08 00 00       	call   801046f0 <release>
}
...
80103e4c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e4f:	e8 0c 07 00 00       	call   80104560 <pushcli>
  c = mycpu();
80103e54:	e8 17 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103e59:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e5f:	e8 3c 07 00 00       	call   801045a0 <popcli>
  if(p == 0)
...
80103ebb:	5d                   	pop    %ebp
    acquire(lk);
80103ebc:	e9 6f 07 00 00       	jmp    80104630 <acquire>
...
80103ecb:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103ed2:	e8 e9 fc ff ff       	call   80103bc0 <sched>
  p->chan = 0;
...
80103f04:	53                   	push   %ebx
  pushcli();
80103f05:	e8 56 06 00 00       	call   80104560 <pushcli>
  c = mycpu();
80103f0a:	e8 61 f8 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103f0f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f15:	e8 86 06 00 00       	call   801045a0 <popcli>
  acquire(&ptable.lock);
...
80103f9a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103fa1:	e8 5a 2f 00 00       	call   80106f00 <freevm>
        release(&ptable.lock);
...
80103fc6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fcd:	e8 1e 07 00 00       	call   801046f0 <release>
        return pid;
...
80103feb:	e8 00 07 00 00       	call   801046f0 <release>
      return -1;
...
80104004:	53                   	push   %ebx
  pushcli();
80104005:	e8 56 05 00 00       	call   80104560 <pushcli>
  c = mycpu();
8010400a:	e8 61 f7 ff ff       	call   80103770 <mycpu>
  p = c->proc;
8010400f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104015:	e8 86 05 00 00       	call   801045a0 <popcli>
  acquire(&ptable.lock);
8010401a:	83 ec 0c             	sub    $0xc,%esp
8010401d:	68 20 2d 11 80       	push   $0x80112d20
80104022:	e8 09 06 00 00       	call   80104630 <acquire>
80104027:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010402a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010402c:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104031:	eb 13                	jmp    80104046 <waitx+0x46>
80104033:	90                   	nop
80104034:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104038:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
8010403e:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
80104044:	73 1e                	jae    80104064 <waitx+0x64>
      if(p->parent != curproc)  // proc is suppossed to be the parent , but how are we checking this ? 
80104046:	39 73 14             	cmp    %esi,0x14(%ebx)
80104049:	75 ed                	jne    80104038 <waitx+0x38>
      if(p->state == ZOMBIE)
8010404b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010404f:	74 3f                	je     80104090 <waitx+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104051:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
      havekids = 1;
80104057:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010405c:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
80104062:	72 e2                	jb     80104046 <waitx+0x46>
    if(!havekids || curproc->killed){
80104064:	85 c0                	test   %eax,%eax
80104066:	0f 84 b4 00 00 00    	je     80104120 <waitx+0x120>
8010406c:	8b 46 24             	mov    0x24(%esi),%eax
8010406f:	85 c0                	test   %eax,%eax
80104071:	0f 85 a9 00 00 00    	jne    80104120 <waitx+0x120>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80104077:	83 ec 08             	sub    $0x8,%esp
8010407a:	68 20 2d 11 80       	push   $0x80112d20
8010407f:	56                   	push   %esi
80104080:	e8 bb fd ff ff       	call   80103e40 <sleep>
    havekids = 0;
80104085:	83 c4 10             	add    $0x10,%esp
80104088:	eb a0                	jmp    8010402a <waitx+0x2a>
...
80104090:	8b 83 84 00 00 00    	mov    0x84(%ebx),%eax
80104096:	8b 4b 7c             	mov    0x7c(%ebx),%ecx
80104099:	8b 93 80 00 00 00    	mov    0x80(%ebx),%edx
8010409f:	83 f8 ff             	cmp    $0xffffffff,%eax
801040a2:	74 6c                	je     80104110 <waitx+0x110>
            *wtime = p->etime - p->ctime - p->rtime ;  // end time - creation time - running time;
801040a4:	29 c8                	sub    %ecx,%eax
801040a6:	8b 4d 08             	mov    0x8(%ebp),%ecx
801040a9:	29 d0                	sub    %edx,%eax
801040ab:	89 01                	mov    %eax,(%ecx)
        *rtime = p->rtime;  // running time
801040ad:	8b 45 0c             	mov    0xc(%ebp),%eax
801040b0:	8b 93 80 00 00 00    	mov    0x80(%ebx),%edx
        kfree(p->kstack);
...
801040ca:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040d1:	e8 2a 2e 00 00       	call   80106f00 <freevm>
        release(&ptable.lock);
...
801040f6:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        release(&ptable.lock);
801040fd:	e8 ee 05 00 00       	call   801046f0 <release>
        return pid;
...
80104110:	a1 a0 58 11 80       	mov    0x801158a0,%eax
80104115:	29 c8                	sub    %ecx,%eax
80104117:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010411a:	29 d0                	sub    %edx,%eax
8010411c:	89 01                	mov    %eax,(%ecx)
8010411e:	eb 8d                	jmp    801040ad <waitx+0xad>
      release(&ptable.lock);
80104120:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104123:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104128:	68 20 2d 11 80       	push   $0x80112d20
8010412d:	e8 be 05 00 00       	call   801046f0 <release>
      return -1;
80104132:	83 c4 10             	add    $0x10,%esp
80104135:	eb ce                	jmp    80104105 <waitx+0x105>
...
80104183:	3d 54 50 11 80       	cmp    $0x80115054,%eax
...
80104194:	c9                   	leave  
  release(&ptable.lock);
80104195:	e9 56 05 00 00       	jmp    801046f0 <release>
...
801041ca:	73 34                	jae    80104200 <kill+0x60>
    if(p->pid == pid){
...
801041ed:	e8 fe 04 00 00       	call   801046f0 <release>
      return 0;
801041f2:	83 c4 10             	add    $0x10,%esp
801041f5:	31 c0                	xor    %eax,%eax
    }
  }
  release(&ptable.lock);
  return -1;
...
80104208:	e8 e3 04 00 00       	call   801046f0 <release>
  return -1;
...
80104226:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104229:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
{
...
8010423b:	68 86 78 10 80       	push   $0x80107886
80104240:	e8 1b c4 ff ff       	call   80100660 <cprintf>
80104245:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104248:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
8010424e:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
80104254:	0f 83 86 00 00 00    	jae    801042e0 <procdump+0xc0>
    if(p->state == UNUSED)
8010425a:	8b 43 0c             	mov    0xc(%ebx),%eax
8010425d:	85 c0                	test   %eax,%eax
8010425f:	74 e7                	je     80104248 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104261:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104264:	ba 20 78 10 80       	mov    $0x80107820,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104269:	77 11                	ja     8010427c <procdump+0x5c>
8010426b:	8b 14 85 8c 79 10 80 	mov    -0x7fef8674(,%eax,4),%edx
      state = "???";
80104272:	b8 20 78 10 80       	mov    $0x80107820,%eax
80104277:	85 d2                	test   %edx,%edx
80104279:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
8010427c:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010427f:	50                   	push   %eax
80104280:	52                   	push   %edx
80104281:	ff 73 10             	pushl  0x10(%ebx)
80104284:	68 24 78 10 80       	push   $0x80107824
80104289:	e8 d2 c3 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
8010428e:	83 c4 10             	add    $0x10,%esp
80104291:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
80104295:	75 a1                	jne    80104238 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104297:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010429a:	83 ec 08             	sub    $0x8,%esp
8010429d:	8d 7d c0             	lea    -0x40(%ebp),%edi
801042a0:	50                   	push   %eax
801042a1:	8b 43 1c             	mov    0x1c(%ebx),%eax
801042a4:	8b 40 0c             	mov    0xc(%eax),%eax
801042a7:	83 c0 08             	add    $0x8,%eax
801042aa:	50                   	push   %eax
801042ab:	e8 60 02 00 00       	call   80104510 <getcallerpcs>
...
801042bc:	0f 84 76 ff ff ff    	je     80104238 <procdump+0x18>
        cprintf(" %p", pc[i]);
801042c2:	83 ec 08             	sub    $0x8,%esp
801042c5:	83 c7 04             	add    $0x4,%edi
801042c8:	52                   	push   %edx
801042c9:	68 61 72 10 80       	push   $0x80107261
801042ce:	e8 8d c3 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801042d3:	83 c4 10             	add    $0x10,%esp
801042d6:	39 fe                	cmp    %edi,%esi
801042d8:	75 de                	jne    801042b8 <procdump+0x98>
801042da:	e9 59 ff ff ff       	jmp    80104238 <procdump+0x18>
801042df:	90                   	nop
  }
}
...
801042f8:	68 20 2d 11 80       	push   $0x80112d20
  ...
  for(p = ptable.proc ; p< &ptable.proc[NPROC] ; p++)
801042fd:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
80104302:	e8 29 03 00 00       	call   80104630 <acquire>
  cprintf("name \t pid \t state \t \n");
80104307:	c7 04 24 2d 78 10 80 	movl   $0x8010782d,(%esp)
8010430e:	e8 4d c3 ff ff       	call   80100660 <cprintf>
80104313:	83 c4 10             	add    $0x10,%esp
80104316:	eb 20                	jmp    80104338 <getpinfo+0x48>
80104318:	90                   	nop
...
80104323:	74 5b                	je     80104380 <getpinfo+0x90>
      cprintf("%s \t %d \t RUNNING \t \n", p->name, p->pid);
    else if(p->state == RUNNABLE)
80104325:	83 f8 03             	cmp    $0x3,%eax
80104328:	74 76                	je     801043a0 <getpinfo+0xb0>
  for(p = ptable.proc ; p< &ptable.proc[NPROC] ; p++)
8010432a:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
80104330:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
80104336:	73 2d                	jae    80104365 <getpinfo+0x75>
    if(p->state == SLEEPING)
80104338:	8b 43 0c             	mov    0xc(%ebx),%eax
8010433b:	83 f8 02             	cmp    $0x2,%eax
8010433e:	75 e0                	jne    80104320 <getpinfo+0x30>
      cprintf("%s \t %d \t SLEEPING \t \n", p->name, p->pid);
80104340:	8d 43 6c             	lea    0x6c(%ebx),%eax
80104343:	83 ec 04             	sub    $0x4,%esp
80104346:	ff 73 10             	pushl  0x10(%ebx)
  for(p = ptable.proc ; p< &ptable.proc[NPROC] ; p++)
80104349:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
      cprintf("%s \t %d \t SLEEPING \t \n", p->name, p->pid);
8010434f:	50                   	push   %eax
80104350:	68 44 78 10 80       	push   $0x80107844
80104355:	e8 06 c3 ff ff       	call   80100660 <cprintf>
8010435a:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc ; p< &ptable.proc[NPROC] ; p++)
8010435d:	81 fb 54 50 11 80    	cmp    $0x80115054,%ebx
80104363:	72 d3                	jb     80104338 <getpinfo+0x48>
      cprintf("%s \t %d \t RUNNABLE \t \n", p->name, p->pid);
  }
  release(&ptable.lock);
80104365:	83 ec 0c             	sub    $0xc,%esp
80104368:	68 20 2d 11 80       	push   $0x80112d20
8010436d:	e8 7e 03 00 00       	call   801046f0 <release>
  return 22;
80104372:	b8 16 00 00 00       	mov    $0x16,%eax
...
8010438a:	68 5b 78 10 80       	push   $0x8010785b
8010438f:	e8 cc c2 ff ff       	call   80100660 <cprintf>
80104394:	83 c4 10             	add    $0x10,%esp
80104397:	eb 91                	jmp    8010432a <getpinfo+0x3a>
...
801043aa:	68 71 78 10 80       	push   $0x80107871
801043af:	e8 ac c2 ff ff       	call   80100660 <cprintf>
801043b4:	83 c4 10             	add    $0x10,%esp
801043b7:	e9 6e ff ff ff       	jmp    8010432a <getpinfo+0x3a>
...
801043ca:	68 a4 79 10 80       	push   $0x801079a4
...
80104425:	e8 16 fa ff ff       	call   80103e40 <sleep>
  while (lk->locked) {
...
80104433:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104439:	e8 d2 f3 ff ff       	call   80103810 <myproc>
...
80104484:	e8 b7 fc ff ff       	call   80104140 <wakeup>
  release(&lk->lk);
...
801044be:	74 13                	je     801044d3 <holdingsleep+0x33>
801044c0:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
801044c3:	e8 48 f3 ff ff       	call   80103810 <myproc>
801044c8:	39 58 10             	cmp    %ebx,0x10(%eax)
801044cb:	0f 94 c0             	sete   %al
801044ce:	0f b6 c0             	movzbl %al,%eax
801044d1:	89 c7                	mov    %eax,%edi
  release(&lk->lk);
801044d3:	83 ec 0c             	sub    $0xc,%esp
801044d6:	56                   	push   %esi
801044d7:	e8 14 02 00 00       	call   801046f0 <release>
  return r;
}
...
80104569:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010456a:	e8 01 f2 ff ff       	call   80103770 <mycpu>
...
8010457f:	e8 ec f1 ff ff       	call   80103770 <mycpu>
80104584:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010458a:	e8 e1 f1 ff ff       	call   80103770 <mycpu>
...
801045cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801045d0:	e8 9b f1 ff ff       	call   80103770 <mycpu>
...
801045e5:	68 af 79 10 80       	push   $0x801079af
801045ea:	e8 a1 bd ff ff       	call   80100390 <panic>
    panic("popcli");
801045ef:	83 ec 0c             	sub    $0xc,%esp
801045f2:	68 c6 79 10 80       	push   $0x801079c6
...
80104618:	e8 53 f1 ff ff       	call   80103770 <mycpu>
...
80104674:	e8 f7 f0 ff ff       	call   80103770 <mycpu>
...
801046d7:	68 cd 79 10 80       	push   $0x801079cd
...
8010472c:	68 d5 79 10 80       	push   $0x801079d5
...
80104997:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010499a:	e8 71 ee ff ff       	call   80103810 <myproc>
...
80104a45:	e8 c6 ed ff ff       	call   80103810 <myproc>
...
80104a53:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a56:	e8 b5 ed ff ff       	call   80103810 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104a98:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104a9b:	e8 70 ed ff ff       	call   80103810 <myproc>
...
80104b34:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b37:	e8 d4 ec ff ff       	call   80103810 <myproc>
...
80104b47:	83 fa 16             	cmp    $0x16,%edx
80104b4a:	77 1c                	ja     80104b68 <syscall+0x38>
80104b4c:	8b 14 85 00 7a 10 80 	mov    -0x7fef8600(,%eax,4),%edx
...
80104b70:	68 dd 79 10 80       	push   $0x801079dd
...
80104b9c:	89 4d d0             	mov    %ecx,-0x30(%ebp)
80104b9f:	8b 4d 08             	mov    0x8(%ebp),%ecx
  if((dp = nameiparent(path, name)) == 0)
80104ba2:	56                   	push   %esi
80104ba3:	50                   	push   %eax
{
80104ba4:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104ba7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104baa:	e8 51 d3 ff ff       	call   80101f00 <nameiparent>
...
80104bc8:	6a 00                	push   $0x0
80104bca:	56                   	push   %esi
80104bcb:	53                   	push   %ebx
80104bcc:	e8 df cf ff ff       	call   80101bb0 <dirlookup>
80104bd1:	83 c4 10             	add    $0x10,%esp
80104bd4:	85 c0                	test   %eax,%eax
80104bd6:	89 c7                	mov    %eax,%edi
80104bd8:	74 36                	je     80104c10 <create+0x80>
    iunlockput(dp);
80104bda:	83 ec 0c             	sub    $0xc,%esp
80104bdd:	53                   	push   %ebx
80104bde:	e8 2d cd ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104be3:	89 3c 24             	mov    %edi,(%esp)
80104be6:	e8 95 ca ff ff       	call   80101680 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104beb:	83 c4 10             	add    $0x10,%esp
80104bee:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104bf3:	0f 85 97 00 00 00    	jne    80104c90 <create+0x100>
80104bf9:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104bfe:	0f 85 8c 00 00 00    	jne    80104c90 <create+0x100>
...
80104c7c:	e8 8f cc ff ff       	call   80101910 <iunlockput>
  return ip;
...
80104c94:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104c96:	e8 75 cc ff ff       	call   80101910 <iunlockput>
    return 0;
...
80104cb9:	e8 12 c9 ff ff       	call   801015d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104cbe:	83 c4 0c             	add    $0xc,%esp
80104cc1:	ff 77 04             	pushl  0x4(%edi)
80104cc4:	68 7c 7a 10 80       	push   $0x80107a7c
80104cc9:	57                   	push   %edi
80104cca:	e8 51 d1 ff ff       	call   80101e20 <dirlink>
...
80104cdc:	68 7b 7a 10 80       	push   $0x80107a7b
80104ce1:	57                   	push   %edi
80104ce2:	e8 39 d1 ff ff       	call   80101e20 <dirlink>
...
80104d54:	e8 b7 ea ff ff       	call   80103810 <myproc>
...
80104d99:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104d9b:	e8 70 ea ff ff       	call   80103810 <myproc>
...
80104ee3:	78 2b                	js     80104f10 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104ee5:	e8 26 e9 ff ff       	call   80103810 <myproc>
...
80104fa2:	0f 88 e2 00 00 00    	js     8010508a <sys_link+0x11a>
  begin_op();
80104fa8:	e8 f3 db ff ff       	call   80102ba0 <begin_op>
  if((ip = namei(old)) == 0){
...
8010507d:	e8 8e c8 ff ff       	call   80101910 <iunlockput>
  end_op();
80105082:	e8 89 db ff ff       	call   80102c10 <end_op>
  return -1;
...
801050ad:	eb 9b                	jmp    8010504a <sys_link+0xda>
    end_op();
801050af:	e8 5c db ff ff       	call   80102c10 <end_op>
    return -1;
...
801050df:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
801050e2:	e8 b9 da ff ff       	call   80102ba0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80105104:	e8 77 c5 ff ff       	call   80101680 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105109:	58                   	pop    %eax
8010510a:	5a                   	pop    %edx
8010510b:	68 7c 7a 10 80       	push   $0x80107a7c
80105110:	53                   	push   %ebx
80105111:	e8 7a ca ff ff       	call   80101b90 <namecmp>
...
80105124:	68 7b 7a 10 80       	push   $0x80107a7b
80105129:	53                   	push   %ebx
8010512a:	e8 61 ca ff ff       	call   80101b90 <namecmp>
...
80105143:	e8 68 ca ff ff       	call   80101bb0 <dirlookup>
...
80105159:	e8 22 c5 ff ff       	call   80101680 <ilock>
  if(ip->nlink < 1)
...
8010518d:	e8 ce c8 ff ff       	call   80101a60 <writei>
...
801051ad:	e8 5e c7 ff ff       	call   80101910 <iunlockput>
  ip->nlink--;
801051b2:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801051b7:	89 1c 24             	mov    %ebx,(%esp)
801051ba:	e8 11 c4 ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
801051bf:	89 1c 24             	mov    %ebx,(%esp)
801051c2:	e8 49 c7 ff ff       	call   80101910 <iunlockput>
  end_op();
801051c7:	e8 44 da ff ff       	call   80102c10 <end_op>
  return 0;
...
80105204:	e8 57 c7 ff ff       	call   80101960 <readi>
...
80105228:	e8 e3 c6 ff ff       	call   80101910 <iunlockput>
  end_op();
8010522d:	e8 de d9 ff ff       	call   80102c10 <end_op>
  return -1;
...
80105249:	e8 82 c3 ff ff       	call   801015d0 <iupdate>
...
801052ed:	e8 ee cb ff ff       	call   80101ee0 <namei>
...
80105303:	e8 78 c3 ff ff       	call   80101680 <ilock>
...
8010534c:	e8 0f c4 ff ff       	call   80101760 <iunlock>
  end_op();
...
801053cf:	e8 3c c5 ff ff       	call   80101910 <iunlockput>
    end_op();
...
801053ec:	e8 4f ba ff ff       	call   80100e40 <fileclose>
...
801054ce:	e8 3d c4 ff ff       	call   80101910 <iunlockput>
  end_op();
801054d3:	e8 38 d7 ff ff       	call   80102c10 <end_op>
  return 0;
...
801054f5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801054f8:	e8 13 e3 ff ff       	call   80103810 <myproc>
801054fd:	89 c6                	mov    %eax,%esi
  
  begin_op();
801054ff:	e8 9c d6 ff ff       	call   80102ba0 <begin_op>
...
8010551f:	e8 bc c9 ff ff       	call   80101ee0 <namei>
...
80105531:	e8 4a c1 ff ff       	call   80101680 <ilock>
  if(ip->type != T_DIR){
...
80105544:	e8 17 c2 ff ff       	call   80101760 <iunlock>
  iput(curproc->cwd);
80105549:	58                   	pop    %eax
8010554a:	ff 76 68             	pushl  0x68(%esi)
8010554d:	e8 5e c2 ff ff       	call   801017b0 <iput>
  end_op();
80105552:	e8 b9 d6 ff ff       	call   80102c10 <end_op>
  curproc->cwd = ip;
...
80105574:	e8 97 c3 ff ff       	call   80101910 <iunlockput>
    end_op();
80105579:	e8 92 d6 ff ff       	call   80102c10 <end_op>
    return -1;
...
8010567b:	e8 90 b3 ff ff       	call   80100a10 <exec>
...
801056bc:	e8 7f db ff ff       	call   80103240 <pipealloc>
...
801056cf:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056d1:	e8 3a e1 ff ff       	call   80103810 <myproc>
...
801056f7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801056fa:	e8 11 e1 ff ff       	call   80103810 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105731:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105738:	e8 d3 e0 ff ff       	call   80103810 <myproc>
...
8010574e:	e8 ed b6 ff ff       	call   80100e40 <fileclose>
    fileclose(wf);
80105753:	58                   	pop    %eax
80105754:	ff 75 e4             	pushl  -0x1c(%ebp)
80105757:	e8 e4 b6 ff ff       	call   80100e40 <fileclose>
    return -1;
...
80105773:	5d                   	pop    %ebp
  return fork();
80105774:	e9 67 e2 ff ff       	jmp    801039e0 <fork>
...
80105783:	83 ec 08             	sub    $0x8,%esp
  exit();
80105786:	e8 f5 e4 ff ff       	call   80103c80 <exit>
...
80105793:	5d                   	pop    %ebp
  return wait();
80105794:	e9 67 e7 ff ff       	jmp    80103f00 <wait>
...
801057be:	e8 dd e9 ff ff       	call   801041a0 <kill>
...
801057e3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801057e6:	e8 25 e0 ff ff       	call   80103810 <myproc>
...
80105807:	78 27                	js     80105830 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105809:	e8 02 e0 ff ff       	call   80103810 <myproc>
  if(growproc(n) < 0)
...
80105816:	e8 45 e1 ff ff       	call   80103960 <growproc>
...
80105865:	e8 c6 ed ff ff       	call   80104630 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010586a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010586d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105870:	8b 1d a0 58 11 80    	mov    0x801158a0,%ebx
  while(ticks - ticks0 < n){
...
80105888:	68 a0 58 11 80       	push   $0x801158a0
8010588d:	e8 ae e5 ff ff       	call   80103e40 <sleep>
  while(ticks - ticks0 < n){
80105892:	a1 a0 58 11 80       	mov    0x801158a0,%eax
...
8010589f:	73 2f                	jae    801058d0 <sys_sleep+0x90>
    if(myproc()->killed){
801058a1:	e8 6a df ff ff       	call   80103810 <myproc>
...
801058b0:	68 60 50 11 80       	push   $0x80115060
801058b5:	e8 36 ee ff ff       	call   801046f0 <release>
      return -1;
...
801058d3:	68 60 50 11 80       	push   $0x80115060
801058d8:	e8 13 ee ff ff       	call   801046f0 <release>
  return 0;
...
801058f4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058f7:	68 60 50 11 80       	push   $0x80115060
801058fc:	e8 2f ed ff ff       	call   80104630 <acquire>
  xticks = ticks;
80105901:	8b 1d a0 58 11 80    	mov    0x801158a0,%ebx
  release(&tickslock);
80105907:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
8010590e:	e8 dd ed ff ff       	call   801046f0 <release>
  return xticks;
}
...
80105923:	5d                   	pop    %ebp
  return getpinfo();
80105924:	e9 c7 e9 ff ff       	jmp    801042f0 <getpinfo>
...
80105933:	83 ec 1c             	sub    $0x1c,%esp
...
801059c7:	c7 04 c5 a2 50 11 80 	movl   $0x8e000008,-0x7feeaf5e(,%eax,8)
801059ce:	08 00 00 8e 
801059d2:	66 89 14 c5 a0 50 11 	mov    %dx,-0x7feeaf60(,%eax,8)
801059d9:	80 
801059da:	c1 ea 10             	shr    $0x10,%edx
801059dd:	66 89 14 c5 a6 50 11 	mov    %dx,-0x7feeaf5a(,%eax,8)
801059e4:	80 
  for(i = 0; i < 256; i++)
...
801059f4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059f7:	c7 05 a2 52 11 80 08 	movl   $0xef000008,0x801152a2
801059fe:	00 00 ef 
  initlock(&tickslock, "time");
80105a01:	68 c1 7a 10 80       	push   $0x80107ac1
80105a06:	68 60 50 11 80       	push   $0x80115060
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a0b:	66 a3 a0 52 11 80    	mov    %ax,0x801152a0
80105a11:	c1 e8 10             	shr    $0x10,%eax
80105a14:	66 a3 a6 52 11 80    	mov    %ax,0x801152a6
  initlock(&tickslock, "time");
...
80105a3b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a3f:	b8 a0 50 11 80       	mov    $0x801150a0,%eax
...
80105a80:	ff 24 85 68 7b 10 80 	jmp    *-0x7fef8498(,%eax,4)
...
80105a90:	e8 7b dd ff ff       	call   80103810 <myproc>
...
80105ab0:	e8 3b dd ff ff       	call   801037f0 <cpuid>
...
80105ac9:	e8 42 dd ff ff       	call   80103810 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105ae5:	68 24 7b 10 80       	push   $0x80107b24
...
80105afe:	e8 0d dd ff ff       	call   80103810 <myproc>
80105b03:	85 c0                	test   %eax,%eax
80105b05:	74 1d                	je     80105b24 <trap+0xc4>
80105b07:	e8 04 dd ff ff       	call   80103810 <myproc>
...
80105b24:	e8 e7 dc ff ff       	call   80103810 <myproc>
80105b29:	85 c0                	test   %eax,%eax
80105b2b:	74 0b                	je     80105b38 <trap+0xd8>
80105b2d:	e8 de dc ff ff       	call   80103810 <myproc>
...
80105b36:	74 68                	je     80105ba0 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b38:	e8 d3 dc ff ff       	call   80103810 <myproc>
...
80105b62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105b68:	e8 a3 dc ff ff       	call   80103810 <myproc>
...
80105b7d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105b80:	e8 ab ef ff ff       	call   80104b30 <syscall>
    if(myproc()->killed)
80105b85:	e8 86 dc ff ff       	call   80103810 <myproc>
...
80105bbd:	e8 8e cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bc2:	e8 49 dc ff ff       	call   80103810 <myproc>
...
80105bfd:	e8 4e cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c02:	e8 09 dc ff ff       	call   80103810 <myproc>
...
80105c1f:	e8 cc db ff ff       	call   801037f0 <cpuid>
80105c24:	56                   	push   %esi
80105c25:	53                   	push   %ebx
80105c26:	50                   	push   %eax
80105c27:	68 cc 7a 10 80       	push   $0x80107acc
...
80105c5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105c60:	e8 1b e0 ff ff       	call   80103c80 <exit>
80105c65:	e9 0e ff ff ff       	jmp    80105b78 <trap+0x118>
80105c6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105c70:	e8 0b e0 ff ff       	call   80103c80 <exit>
80105c75:	e9 aa fe ff ff       	jmp    80105b24 <trap+0xc4>
80105c7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105c80:	83 ec 0c             	sub    $0xc,%esp
80105c83:	68 60 50 11 80       	push   $0x80115060
80105c88:	e8 a3 e9 ff ff       	call   80104630 <acquire>
      wakeup(&ticks);
80105c8d:	c7 04 24 a0 58 11 80 	movl   $0x801158a0,(%esp)
      ticks++;
80105c94:	83 05 a0 58 11 80 01 	addl   $0x1,0x801158a0
      wakeup(&ticks);
80105c9b:	e8 a0 e4 ff ff       	call   80104140 <wakeup>
      release(&tickslock);
80105ca0:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
80105ca7:	e8 44 ea ff ff       	call   801046f0 <release>
80105cac:	83 c4 10             	add    $0x10,%esp
80105caf:	e9 09 ff ff ff       	jmp    80105bbd <trap+0x15d>
80105cb4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105cb7:	e8 34 db ff ff       	call   801037f0 <cpuid>
...
80105cc5:	68 f0 7a 10 80       	push   $0x80107af0
80105cca:	e8 91 a9 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105ccf:	83 c4 14             	add    $0x14,%esp
80105cd2:	68 c6 7a 10 80       	push   $0x80107ac6
...
80105dcc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105dcf:	bb e8 7b 10 80       	mov    $0x80107be8,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010693a:	e8 01 de ff ff       	call   80104740 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801069dd:	68 f0 7b 10 80       	push   $0x80107bf0
...
80106a93:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a96:	e8 55 cd ff ff       	call   801037f0 <cpuid>
...
80106b49:	8b 7d 08             	mov    0x8(%ebp),%edi
  int start_time = ticks;
80106b4c:	a1 a0 58 11 80       	mov    0x801158a0,%eax
  if(p == 0)
80106b51:	85 ff                	test   %edi,%edi
  int start_time = ticks;
80106b53:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(p == 0)
80106b56:	0f 84 da 00 00 00    	je     80106c36 <switchuvm+0xf6>
  if(p->kstack == 0)
80106b5c:	8b 5f 08             	mov    0x8(%edi),%ebx
80106b5f:	85 db                	test   %ebx,%ebx
80106b61:	0f 84 e9 00 00 00    	je     80106c50 <switchuvm+0x110>
  if(p->pgdir == 0)
80106b67:	8b 4f 04             	mov    0x4(%edi),%ecx
80106b6a:	85 c9                	test   %ecx,%ecx
80106b6c:	0f 84 d1 00 00 00    	je     80106c43 <switchuvm+0x103>
  pushcli();
80106b72:	e8 e9 d9 ff ff       	call   80104560 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b77:	e8 f4 cb ff ff       	call   80103770 <mycpu>
...
80106b8d:	83 c6 08             	add    $0x8,%esi
80106b90:	e8 db cb ff ff       	call   80103770 <mycpu>
80106b95:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80106b98:	83 c3 08             	add    $0x8,%ebx
80106b9b:	83 c0 08             	add    $0x8,%eax
80106b9e:	c1 eb 10             	shr    $0x10,%ebx
80106ba1:	ba 67 00 00 00       	mov    $0x67,%edx
80106ba6:	c1 e8 18             	shr    $0x18,%eax
80106ba9:	88 99 9c 00 00 00    	mov    %bl,0x9c(%ecx)
80106baf:	bb 99 40 00 00       	mov    $0x4099,%ebx
80106bb4:	66 89 91 98 00 00 00 	mov    %dx,0x98(%ecx)
80106bbb:	66 89 b1 9a 00 00 00 	mov    %si,0x9a(%ecx)
80106bc2:	66 89 99 9d 00 00 00 	mov    %bx,0x9d(%ecx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106bc9:	be 10 00 00 00       	mov    $0x10,%esi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106bce:	88 81 9f 00 00 00    	mov    %al,0x9f(%ecx)
  mycpu()->gdt[SEG_TSS].s = 0;
80106bd4:	e8 97 cb ff ff       	call   80103770 <mycpu>
80106bd9:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106be0:	e8 8b cb ff ff       	call   80103770 <mycpu>
80106be5:	66 89 70 10          	mov    %si,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106be9:	8b 5f 08             	mov    0x8(%edi),%ebx
80106bec:	e8 7f cb ff ff       	call   80103770 <mycpu>
80106bf1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106bf7:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106bfa:	e8 71 cb ff ff       	call   80103770 <mycpu>
80106bff:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106c04:	66 89 50 6e          	mov    %dx,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106c08:	b8 28 00 00 00       	mov    $0x28,%eax
80106c0d:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106c10:	8b 47 04             	mov    0x4(%edi),%eax
80106c13:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106c18:	0f 22 d8             	mov    %eax,%cr3
  popcli();
80106c1b:	e8 80 d9 ff ff       	call   801045a0 <popcli>
  int run_time  = ticks - start_time;
80106c20:	a1 a0 58 11 80       	mov    0x801158a0,%eax
80106c25:	2b 45 e4             	sub    -0x1c(%ebp),%eax
  p->rtime += run_time;
80106c28:	01 87 80 00 00 00    	add    %eax,0x80(%edi)
}
...
80106c39:	68 f6 7b 10 80       	push   $0x80107bf6
80106c3e:	e8 4d 97 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106c43:	83 ec 0c             	sub    $0xc,%esp
80106c46:	68 21 7c 10 80       	push   $0x80107c21
80106c4b:	e8 40 97 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106c50:	83 ec 0c             	sub    $0xc,%esp
80106c53:	68 0c 7c 10 80       	push   $0x80107c0c
...
80106c7b:	77 49                	ja     80106cc6 <inituvm+0x66>
  mem = kalloc();
80106c7d:	e8 3e b8 ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106c8f:	e8 ac da ff ff       	call   80104740 <memset>
...
80106ca9:	e8 b2 fc ff ff       	call   80106960 <mappages>
  memmove(mem, init, sz);
...
80106cc0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106cc1:	e9 2a db ff ff       	jmp    801047f0 <memmove>
    panic("inituvm: more than a page");
80106cc6:	83 ec 0c             	sub    $0xc,%esp
80106cc9:	68 35 7c 10 80       	push   $0x80107c35
...
80106d23:	e8 b8 fb ff ff       	call   801068e0 <walkpgdir>
...
80106d51:	e8 0a ac ff ff       	call   80101960 <readi>
...
80106deb:	e8 50 d9 ff ff       	call   80104740 <memset>
...
80106e04:	e8 57 fb ff ff       	call   80106960 <mappages>
...
80106e19:	0f 86 81 00 00 00    	jbe    80106ea0 <allocuvm+0x100>
    mem = kalloc();
80106e1f:	e8 9c b6 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106e2d:	68 6d 7c 10 80       	push   $0x80107c6d
...
80106e63:	68 85 7c 10 80       	push   $0x80107c85
...
80106e80:	e8 6b fb ff ff       	call   801069f0 <deallocuvm.part.0>
      kfree(mem);
...
80106e8b:	e8 80 b4 ff ff       	call   80102310 <kfree>
      return 0;
...
80106eba:	e8 31 fb ff ff       	call   801069f0 <deallocuvm.part.0>
...
80106ee0:	5d                   	pop    %ebp
80106ee1:	e9 0a fb ff ff       	jmp    801069f0 <deallocuvm.part.0>
...
80106f19:	e8 d2 fa ff ff       	call   801069f0 <deallocuvm.part.0>
...
80106f4e:	e8 bd b3 ff ff       	call   80102310 <kfree>
...
80106f63:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106f64:	e9 a7 b3 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106f69:	83 ec 0c             	sub    $0xc,%esp
80106f6c:	68 a1 7c 10 80       	push   $0x80107ca1
...
80106f85:	e8 36 b5 ff ff       	call   801024c0 <kalloc>
...
80106fa0:	e8 9b d7 ff ff       	call   80104740 <memset>
...
80106fbb:	e8 a0 f9 ff ff       	call   80106960 <mappages>
...
8010700b:	a3 a4 58 11 80       	mov    %eax,0x801158a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010702e:	e8 ad f8 ff ff       	call   801068e0 <walkpgdir>
  if(pte == 0)
...
8010703f:	68 b2 7c 10 80       	push   $0x80107cb2
...
80107090:	e8 5b d7 ff ff       	call   801047f0 <memmove>
...
801070ab:	e8 b0 f8 ff ff       	call   80106960 <mappages>
...
801070c9:	e8 12 f8 ff ff       	call   801068e0 <walkpgdir>
...
801070e5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801070e8:	e8 d3 b3 ff ff       	call   801024c0 <kalloc>
...
8010714e:	e8 8d f7 ff ff       	call   801068e0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
801071bf:	e8 2c d6 ff ff       	call   801047f0 <memmove>
    len -= n;
    buf += n;
